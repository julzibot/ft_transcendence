...
from .views import TournamentCreateView, TournamentListView, JoinTournamentView, TournamentView, DeleteParticipantView, StartTournamentView, EndTournamentView
