...
from .views import SigninView, UpdateNameView, RegisterView, SearchUserView, UpdateImageView, UpdatePasswordView, DeleteAccountView, GetUserView, GetSCRFTokenView, LogoutView, GetUserInfosView, OauthView
