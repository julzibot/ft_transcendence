								...
								<br />
							{
								session?.user.id === Number(id) ? (
									<>
												...
												isEditing ? (
													...
													<>
														<div className="container align-items-center">
															<div className="row">
																{
																	session.user.username ? (<span className="col-9 card-text fw-semibold fs-4">{session.user.username}</span>) : (
																...
																{
																	session.user.id ? ( <button className="col-2 btn btn-sm btn-primary rounded-pill" onClick={() => setIsEditing(true)}>Edit</button>) : (
										...
										<>
											{
												user.username ? ( <span className="col card-text fw-semibold fs-4">{user.username}</span> ) : (
													<>
														<div className="col">
															<p className="card-text fs-4 placeholder-glow">
																<span className="placeholder col-7"></span>
