...
objs.gaugePanel = new THREE.BoxGeometry(7, 2.5, 0.2);
...
objs.displayMaterial = new THREE.MeshBasicMaterial( { color: 0x000000 } );
objs.gaugePanelMaterial = new THREE.MeshBasicMaterial( { color: 0xbbbbbb } );
