...
export async function fetchGameSettings(
  ...
  if (user_id) {
    const response = await fetch(
      `https://localhost:8000/api/gameCustomization/${user_id}`,
      {
        method: "GET",
      }
    );
...
export default function Customization({
  ...
  const handlePalette = () => {
    if (palette) updateSettings({ ...gameSettings, palette: 0 });
    else if (!palette) updateSettings({ ...gameSettings, palette: 1 });
  ...
  const gameCustomSave = async () => {
    ...
    const response = await fetch(
      "https://localhost:8000/api/gameCustomization/",
      requestData
    );
            ...
            <div className="mb-3">
              <div className="form-check">
                <input
                  ...
                  value={0}
                  onChange={() =>
                    updateSettings({ ...gameSettings, background: 0 })
                  }
                  checked={
              ...
              <div className="form-check">
                <input
                  ...
                  value={4}
                  onChange={() =>
                    updateSettings({ ...gameSettings, background: 4 })
                  }
                  checked={
                    gameSettings.background === 4 ||
                    gameSettings.background === 5
                  }
                />
              ...
              <>
                ...
                {!palette && (
                  <div className="mb-3 text-center">
                    <label htmlFor="favcolor" className="form-label">
                      Select color
                    </label>
            ...
            <div className="mb-3 text-center align-items-center">
              ...
              <div>
                <button
                  ...
                  data-bs-dismiss="offcanvas"
                  onClick={gameCustomSave}
                >
                  Save
                </button>
                <button
                  className="m-1 btn btn-primary"
                  onClick={gameCustomDefault}
                >
                  Reset to Default
                </button>
              </div>
