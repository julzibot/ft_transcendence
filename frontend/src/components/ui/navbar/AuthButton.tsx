    ...
    return (
      <>
        <div className="dropdown me-3">
          <button
            className="btn btn-light btn-lg dropdown-toggle d-flex align-items-center me-1"
            role="button"
          ...
          >
            {session.user.image ? (
              <>
                <div
                  className=" border border-2 border-dark-subtle rounded-circle"
                  style={{
                    width: "30px",
                    height: "30px",
                    overflow: "hidden",
              ...
              <div className="modal-footer">
                <div className="d-flex justify-content-between">
                  <div className="flex-row">
                    <button
                      className="flex-column btn btn-outline-secondary me-md-2"
                      data-bs-dismiss="modal"
                      aria-label="Close"
                    >
                      Cancel
                    ...
                    <button
                      className=" flex-column btn btn-outline-danger"
                      type="button"
